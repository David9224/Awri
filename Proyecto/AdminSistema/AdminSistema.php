...
<head>
	...
	<link href="/Proyecto/css/adminSistema.css" rel="stylesheet">
	<script type='text/javascript' src="//ajax.googleapis.com/ajax/libs/jquery/1.8.3/jquery.min.js"></script>
	<script type="text/javascript" src="/Proyecto/ScriptsJS/ActualizarContenido.js"></script>
    <script type="text/javascript" src="/Proyecto/ScriptsJS/ajax.js"></script>
</head>
<body>
	<?php
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav">
                	<li><a href="/Proyecto/AdminSistema/AdminSistema.php">Home</a></li>
                    <li><a href="#" onclick="actualizar('#container', '/Proyecto/AdminSistema/AgregarEmpresa.html')">Gestión Empresas</a></li>
                    <li><a href="#" onclick="actualizar('#container', '/Proyecto/AdminSistema/AgregarRol.html')">Gestión Roles</a></li>
                </ul>
